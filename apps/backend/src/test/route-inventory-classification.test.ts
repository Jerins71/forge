...
const ROUTE_INVENTORY: RouteInventoryEntry[] = [
  ...
  { sample: "/api/settings/secure-secrets", expect: { GET: "admin", PUT: "admin" }, optional: true },
  ...
  { sample: "/api/settings/manager-selection-catalog", expect: { GET: "member" }, killSwitched: true },
  ...
  { sample: "/api/settings/openrouter/routing", expect: { GET: "admin", PUT: "admin" } },
  { sample: "/api/settings/openrouter/routing/models/openai%2Fgpt-4.1", expect: { GET: "admin", PUT: "admin" } },
  { sample: "/api/settings/openrouter/endpoints/openai%2Fgpt-4.1", expect: { GET: "admin" } },
