...
try {
  ...
  const config = {
    ...
    files: ['dist/**/*', '!dist/browser-fixture-smoke-main*', '!dist/browser-popout-reparent-smoke-main*', '!dist/managed-browser-popout-fixture-main*', '!dist/browser-preview-capture-smoke-main*', 'node_modules/playwright-core/**/*', 'package.json'],
