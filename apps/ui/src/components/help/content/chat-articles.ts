...
export const chatArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    category: 'chat',
    summary: 'How to use Inbox, Projects, Needs you, and the Classic sidebar rollback.',
  ...
  },
  {
    ...
    relatedIds: ['settings-collaboration', 'chat-sessions', 'chat-sidebar', 'settings-project-settings'],
    contextKeys: ['chat.sidebar'],
  },
  {
    id: 'chat-workers',
  ...
  },
  {
    ...
    category: 'chat',
    summary: 'How Summary and experimental Context v2 continue work with task notes and recoverable earlier messages and tool results.',
