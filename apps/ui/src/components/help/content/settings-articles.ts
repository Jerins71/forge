...
export const settingsArticles: HelpArticle[] = [
  {
    ...
    category: 'settings',
    summary: 'Editor, sidebar, new project view, compaction model/timeout, Cortex consolidation, Knowledge v2 activation, and related settings.',
    ...
    relatedIds: ['settings-theme', 'settings-editor', 'settings-collaboration', 'settings-observability', 'settings-about', 'chat-compaction', 'settings-project-settings', 'models-providers', 'cortex-overview', 'cortex-knowledge', 'cortex-onboarding'],
  ...
  },
  {
    ...
    title: 'Delegation',
    category: 'settings',
    summary: 'Configure work mode, rosters, task instructions, model policies, custom specialists, and fallback models.',
